  ...
  <section id="about" class="section">
    <div class="container">
      ...
      <div class="row">
        ...
        %>
        <div class="span3">
            <img src="assets/img/autor/<%= u.getImagen() %>" alt="<%= u.getNombre()%>" width="900" height="200" class="img-polaroid" />
          <div class="roles">
      ...
      <div class="row">
        ...
        <div class="span3">
          <div class="box aligncenter">
            <div class="halftop">
                <img src="assets/img/libro/<%= l.getImagen() %>" alt="<%= l.getNombre()%>"  width="400" height="400" class="img-polaroid" />
