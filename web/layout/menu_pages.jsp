...
<header>
    ...
    <div id="topnav" class="navbar navbar-fixed-top default">
      <div class="navbar-inner">
        <div class="container">
          <div class="logo">
              <a href="index.jsp"><img src="assets/img/Imagen1.png"width="200px" height="50px"/> </a>
              
          </div>
          <div class="navigation">
            <nav>
              <ul class="nav pull-right">
                <li  ><a class="external" href="index.jsp">Home</a></li>
                <li><a class="external" href="autores.jsp">Autores</a></li>
                <li><a class="external" href="libros.jsp">Libros</a></li>
                <li><a class="external" href="libroGenero.jsp">Genero de Libro</a></li>
                <li><a class="external" href="carrito.jsp"><i class="icon-shopping-cart icon-1x"></i><span class="badge badge-info">4</span></i></a></li>
                ...
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <!-- <li><a href="membresia.jsp">Membresia</a></li> -->
                    ...
                    <li><a href="perfil.jsp?c=1" class="external">Cerrar Session</a></li>
